<?php
    ...
    $sql = "SELECT in_alum, out_alum, matricula_alum, id_salon FROM inout_alumnos"; //consulta sql
    ...
    $pdf->Cell(200,10, 'ENTRADA Y SALIDA DE ALUMNOS',0,1,'C');
    $pdf->Ln(10);
    ...
    $pdf->Output('reporte de entrada y salida de alumnos.pdf','I');
?>