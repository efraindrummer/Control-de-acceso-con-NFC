<?php
	...
	$consulta = "SELECT * FROM inout_personal";
...
<html lang="en">
  ...
  <body>
    <h1 class="text-center">ENTRADA Y SALIDA DE PERSONAL</h1>
            ...
            <table id="tablaUsuarios" class="table-striped table-bordered" style="width:100%">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><?php echo $salones['in_pers']?></td>
                        <td><?php echo $salones['out_pers']?></td>
                        <td><?php echo $salones['matricula_pers']?></td>
	...
	<center>
        ...
        <a class="link" href="ReportePDFinoutpersonal.php" target="_blank"><i class="fas fa-print"></i>Imprimir</a>
