...
<html lang="en">
  ...
  <body>
           ...
           <div class="col-lg-12">
            <table id="tablaUsuarios" class="table-striped table-bordered" style="width:100%">
                <thead class="text-center">
                    <th>NUMERO DE SALONES</th>
                    <th>NOMBDESCRIPCION DE SALON</th>
                </thead>
                <tbody>
                    <?php
                    ...
                    <tr>
                        ...
                        <td><?php echo $salones['desc_salon']?></td>
                    </tr>
                    <?php
                        }
                    ?>
	...
	<center>
        ...
        <br>
        <br>
		<input type="button" value="REGRESAR" class="btn btn-link" onclick="location.href='registro_salones.php' "name="atras"/>
        <a class="link" href="ReportePDFsalon.php" target="_blank"><i class="fas fa-print"></i>Imprimir</a>
